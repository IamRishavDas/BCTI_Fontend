...
export function KeyboardIcon({ active }) {
  return (
    <svg
      width="18"
      height="18"
      ...
      strokeLinejoin="round"
    >
      {/* Outer rectangle for keyboard body */}
      <rect x="2" y="6" width="20" height="12" rx="2" ry="2" />
      
      {/* Keys layout */}
      <path d="M6 10h.01" />  {/* Key 1 */}
      <path d="M10 10h.01" /> {/* Key 2 */}
      <path d="M14 10h.01" /> {/* Key 3 */}
      <path d="M18 10h.01" /> {/* Key 4 */}
      
      <path d="M6 14h.01" />  {/* Key 5 */}
      <path d="M10 14h.01" /> {/* Key 6 */}
      <path d="M14 14h.01" /> {/* Key 7 */}
      <path d="M18 14h.01" /> {/* Key 8 */}
    </svg>
  );
}
